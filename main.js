...
const torusNormalTexture = new THREE.TextureLoader().load('torus_map.jpg');
const torusDispTexture = new THREE.TextureLoader().load('torus_disp.jpg');
...
const myPicture = new THREE.TextureLoader().load('me.jpg');
...
const earthNormalTexture = new THREE.TextureLoader().load('dunya-normal.jpg');
